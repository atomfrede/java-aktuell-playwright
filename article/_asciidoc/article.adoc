...
Als Beispiel verwenden wir eine angepasste Variante der in <<JavaAktuell>> erstellten Todo Anwendung auf Basis von Spring Boot und Thymeleaf (siehe xref:#bild.todomvc[]).
